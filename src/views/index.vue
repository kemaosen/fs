...
<template>
  <div>
    ...
    <g-button icon="settings" type="primary">默认按钮</g-button>
    ...
    <div>
      <g-row class="g-row">
        <g-col class="g-col" span="24" style="background-color: #99a9bf;"></g-col>
      </g-row>
      <g-row class="g-row">
      ...
      <g-row class="g-row" :gutter="20">
        <g-col class="g-col" span="6">
          <div class="g-col-twoI"></div>
        </g-col>
        <g-col class="g-col" span="6">
          <div class="g-col-twoII"></div>
        </g-col>
        <g-col class="g-col" span="6">
          <div class="g-col-twoI"></div>
        </g-col>
      ...
      <hr/>
      <g-row class="g-row">
        <g-col :xs="{span:1,offset:5}" :sm="{span:2,offset:4}" :md="{span:6,offset:0}" :lg="{span:5,offset:1}" :xl="{span:4,offset:2}" class="g-col g-col-twoI" span="6"></g-col>
        <g-col :xs="{span:1,offset:5}" :sm="{span:2,offset:4}" :md="{span:6,offset:0}" :lg="{span:5,offset:1}" :xl="{span:4,offset:2}" class="g-col g-col-twoI" span="6"></g-col>
        <g-col :xs="{span:1,offset:5}" :sm="{span:2,offset:4}" :md="{span:6,offset:0}" :lg="{span:5,offset:1}" :xl="{span:4,offset:2}" class="g-col g-col-twoI" span="6"></g-col>
        <g-col :xs="{span:1,offset:5}" :sm="{span:2,offset:4}" :md="{span:6,offset:0}" :lg="{span:5,offset:1}" :xl="{span:4,offset:2}" class="g-col g-col-twoI" span="6"></g-col>
      </g-row>
